...
| Routes | `/[locale]/routes` | Live | Backend `/api/v1/schedules/routes` (CRUD, server pagination, search) + GTFS-RT live vehicle positions (WebSocket real-time push with HTTP polling fallback) on Leaflet map |
